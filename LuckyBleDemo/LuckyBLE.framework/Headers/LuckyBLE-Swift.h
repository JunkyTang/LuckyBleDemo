...
#ifndef LUCKYBLE_SWIFT_H
#define LUCKYBLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LuckyBLE",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC8LuckyBLE10BLEManager")
...
@class NSString;
@class NSNumber;
@interface BLEManager (SWIFT_EXTENSION(LuckyBLE)) <CBCentralManagerDelegate>
...
SWIFT_CLASS("_TtC8LuckyBLE7Printer")
@interface Printer : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC8LuckyBLE19ConfigurablePrinter")
@interface ConfigurablePrinter : Printer
@end

SWIFT_CLASS("_TtC8LuckyBLE14PrinterService")
@interface PrinterService : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface PrinterService (SWIFT_EXTENSION(LuckyBLE)) <CBPeripheralDelegate>
